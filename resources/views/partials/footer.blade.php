...
<footer class="bg-gradient-to-r from-green-800 to-blue-500 py-8 sm:py-10 text-white">
    <div class="container mx-auto px-4 sm:px-6">
        <div class="flex flex-col lg:flex-row justify-between items-start gap-6 sm:gap-8">
            <!-- Hospital Info -->
            <div class="w-full lg:max-w-xs">
                <a href="{{ route('home') }}" class="inline-block mb-4">
                    <img src="{{ url('img/logo-dr.png') }}" alt="AFYA KWANZA Logo" class="w-full max-w-[120px] sm:max-w-[140px]">
                </a>
            ...
            <!-- Links Columns -->
            <div class="grid grid-cols-1 xs:grid-cols-2 gap-6 sm:gap-10 w-full lg:w-auto">
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                        <li class="flex items-start">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 mr-1 sm:mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Copyright -->
        <div class="mt-8 sm:mt-12 pt-4 sm:pt-6 border-t border-white/20 text-center text-xs sm:text-sm opacity-80">
