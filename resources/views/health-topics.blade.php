...
@section('title', 'Post - Health Blog')
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3 mt-8">
            <article class="flex flex-col shadow my-4 bg-white dark:bg-gray-900">
                ...
                <div class="flex flex-col justify-start p-6">
                    ...
                    <h2 class="text-2xl font-bold pb-3">Frequently Asked Questions (FAQs)</h2>
                    @foreach($post->faqs as $faq)
                        <p class="font-semibold text-gray-800 dark:text-gray-200">{{ $faq['question'] }}</p>
                        <div class="pb-3 text-gray-700 dark:text-gray-300">{!! $faq['answer'] !!}</div>
                    @endforeach
