        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-8 space-y-6 md:space-y-0">
                ...
                <div class="w-full md:w-1/2 text-center md:text-left">
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white mb-3 sm:mb-4">{{ $about->title ?? 'About MY DOCTOR TZ' }}</h1>
            ...
            <div class="mt-8 sm:mt-12">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white text-center mb-6 sm:mb-8">{{ $mission->title ?? 'Our Mission' }}</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 lg:p-8 border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-green-50 dark:hover:bg-gray-800">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-white">{{ $mission->title ?? 'Excellence in Healthcare Delivery' }}</h3>
                        </div>
            ...
            <!-- Our Vision Section -->
            <div class="mt-8 sm:mt-12">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white text-center mb-6 sm:mb-8">{{ $vision->title ?? 'Vision' }}</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
                    <!-- Vision Text -->
                    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 lg:p-8 border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-green-50 dark:hover:bg-gray-800">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-white">{{ $vision->title ?? 'A Healthier Tomorrow' }}</h3>
                        </div>
                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
